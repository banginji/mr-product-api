...
@EnableWebMvc
@SpringBootTest(classes = {Routes.class, DgsAutoConfiguration.class, ProductInfoFetcher.class, ProductInfoServiceImpl.class, GetProductPriceService.class, ProductTitleRedSkyService.class})
